                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ url('admin/comment/'.$comment->id) }}" method="POST">
                            {{ method_field('PUT') }}
                            {!! csrf_field() !!}
                            <input type="hidden" name="id" required="required"  value="{{ $comment->id }}">
                            <input type="text" name="nickname" class="form-control" required="required" placeholder="nickname" value="{{ $comment->nickname }}">
                            <br>
